...
import 'package:form_validate/bloc/bloc.dart';
// import 'package:form_validate/bloc/form_bloc.dart';
  ...
  void initState() {
    ...
    _numberFocusNode.addListener(() {
      if (!_numberFocusNode.hasFocus) {
        context.read<MyFormBloc>().add(NumberUnfocused());
      }
    });
  }
      ...
      child: Padding(
        ...
        child: Column(
          children: <Widget>[
            ...
            NumberInput(focusNode: _numberFocusNode),
            SubmitButton(),
          ],
        ),
      ),
...
class NumberInput extends StatelessWidget {
  const NumberInput({Key? key, required this.focusNode}) : super(key: key);
      ...
      builder: (context, state) {
        return TextFormField(
          ...
          decoration: InputDecoration(
            ...
            labelText: 'Phone',
            helperText: 'A complete, valid number e.g. 9835927358',
            errorText: state.email.invalid
          ...
          onChanged: (value) {
            context.read<MyFormBloc>().add(NumberChanged(number: value));
          },
          textInputAction: TextInputAction.next,
        );
      },
